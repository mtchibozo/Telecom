...
# -*- coding: utf-8 -*-
"""
Takes the text extracted from a pdf and returns a list of strings to be classified by a binary classifier to dtermine whether they contain an affiliation
"""
    ...
    def ngram_assembler(longString):
        ...
        for l in range(min_n+1, max_n+1):
            for i in range(n-max_n-1):
                NGrams.append(List_to_string(StringList[i:i+l]))
        return NGrams
